  ...
  styles: [`
    ...
    *, *::before, *::after { box-sizing:border-box; }
    ...
    @media(max-width:700px) {
      ...
      .res-nav { gap:8px; }
      .res-nav-num { font-size:1.4rem; }
      .res-match { grid-template-columns:70px 1fr; gap:6px; padding:10px 12px; }
      .res-odds { display:none; }
      .res-final-tag { font-size:.55rem; padding:3px 6px; }
      .res-team-name { font-size:.72rem; }
      .res-score { font-size:1.1rem; }
      .res-crest { width:20px; height:20px; }
      .res-stage-filter { gap:5px; }
      .res-stage-btn { padding:5px 10px; font-size:.65rem; }
      .res-bracket { gap:8px; }
      .res-br-round { min-width:140px; }
      .res-modal { padding:20px 18px; }
      .res-modal-leg-teams { grid-template-columns:1fr auto 1fr; gap:6px; }
      .res-modal-team { font-size:.75rem; }
      .res-modal-score { font-size:1rem; }
    }
  `]
})

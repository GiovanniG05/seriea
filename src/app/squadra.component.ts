          ...
          <div class="sq-content" *ngIf="activeTab==='rosa'">
            ...
            <div class="sq-position-group" *ngFor="let pos of positions">
              ...
              <div class="sq-players-grid">
                <div class="sq-player" *ngFor="let p of getByPosition(pos.key)">
...
export class SquadraComponent implements OnInit {
  ...
  positions = [
    ...
    { key: 'Defence',     label: 'Difensori' },
    { key: 'Midfield',    label: 'Centrocampisti' },
    { key: 'Offence',     label: 'Attaccanti' },
  ];
  ...
  getByPosition(pos: string): any[] {
    return this.team?.squad?.filter((p: any) => p.position === pos) ?? [];
  }
